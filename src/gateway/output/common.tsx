...
export const StatusIcon = ({ status, format }: { status: any; format: "telegram" | "terminal" }) => {
...
export const Header = ({ title, format, subtitle }: { title: string; format: "telegram" | "terminal"; subtitle?: string }) => {
    const CYAN = "\x1b[36m";
    const RESET = "\x1b[0m";
