...
export const HealthReport = ({ data, format }: { data: any; format: "telegram" | "terminal" }) => {
    ...
    const renderEnv = (key: string, info: any) => {
        if (info.sensitive) {
    ...
    const renderFs = (name: string, info: any) => {
