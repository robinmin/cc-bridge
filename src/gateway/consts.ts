...
export const GATEWAY_CONSTANTS = {
	...
	CONFIG: {
		...
		WORKSPACE_ROOT: process.env.WORKSPACE_ROOT || process.env.PROJECTS_ROOT || path.resolve(".."),
	},
	INSTANCES: {
	...
	DEFAULT_CONFIG: {
		...
		serviceName: "gateway",
		projectsRoot:
			process.env.PROJECTS_ROOT || path.join(process.env.HOME || process.env.USERPROFILE || ".", "xprojects"),
		feishu: {
