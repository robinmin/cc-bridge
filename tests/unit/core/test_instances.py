...
class TestInstanceManager:
    ...
    async def test_list_instances(self, instance_manager):
        ...
        await instance_manager.create_instance(
            name="test1", tmux_session="claude-test1"
        )
        await instance_manager.create_instance(
            name="test2", tmux_session="claude-test2"
        )
    ...
    async def test_save_and_load_instances(self, test_instances_file):
        ...
        await manager1.create_instance(
            name="persisted", tmux_session="claude-persisted"
        )
