...
class TestMessage:
    ...
    def test_message_with_text(self):
        ...
        chat = Chat(id=456, type="private")
        message = Message(
            message_id=1, date=1234567890, chat=chat, text="Hello, World!"
        )
    ...
    def test_message_with_entities(self):
        ...
        message = Message(
            message_id=1, date=1234567890, chat=chat, text="Hello", entities=entities
        )
