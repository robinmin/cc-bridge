...
class TestSessionTracker:
    ...
    async def test_start_request(self, session_tracker):
        ...
        request_id, session = await session_tracker.start_request("test-instance", "hello")
    ...
    async def test_auto_create_session_on_request(self, session_tracker):
        ...
        request_id, session = await session_tracker.start_request("new-instance", "test")
    ...
    async def test_cleanup_inactive_sessions(self, session_tracker):
        ...
        removed = await session_tracker.cleanup_inactive_sessions(max_inactive_time=300.0)
...
async def test_timeout_monitoring():
    ...
    # Start monitoring
    await tracker.start_monitoring(check_interval=0.05, timeout_callback=timeout_callback)
